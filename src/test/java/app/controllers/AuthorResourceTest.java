...
class AuthorResourceTest
{
    ...
    Author a1, a2;
    final Logger logger = LoggerFactory.getLogger(AuthorResourceTest.class.getName());
    ...
    void setUp()
    {
        try (EntityManager em = emf.createEntityManager())
        {
            ...
            a1 = new Author("TestEntityA");
            a2 = new Author("TestEntityB");
    ...
    void getAll()
    {
        given().when().get("/books").then().statusCode(200).body("size()", equalTo(2));
    }

    @Test
    void getById()
    {
        given().when().get("/books/" + a2.getId()).then().statusCode(200).body("id", equalTo(a2.getId().intValue()));
    }

    @Test
    void create()
    {
        Author entity = new Author("Thor Partner Hotel");
        Book book = new Book("201");
        entity.addBook(book);
        try
        {
